...
def _build_libreria_symbols(
    type_value: str, text_value: str, available_icons: List[str]
) -> List[str]:
...
def map_card_to_form_payload(
    ...
    clan_files = (
        _available_clan_files() if available_clan_files is None else list(available_clan_files)
    )
